...
# 0~90까지 10의 배수가 담김 리스트
evenlist = [i*10 for i in range(10)]
print(evenlist)
...
numArea = [getCircleArea(float) for n in numlist]
print(numArea)
...
person2 = dict() #딕셔너리 객체 서언,초기화 상태 key, value지정이 안되어있음
person2['name'] = '임꺽정'
person2['age'] = 50
person2['birth'] = '08~27'
print(person2)
...
#개수가 가장 많은 과일을 출력하시오
#(1) 무엇을 구할까? -> 가장 많은 과일의 개수 (과일 갯수 중 max)
numlist = [3,4,5,6,7]
print(max(numlist))
...
#fruit-dict에서 개수가 가장 많은 과일을 출력하시오.
